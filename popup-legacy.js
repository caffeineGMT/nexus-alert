...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  const tooltips = new FeatureTooltips();
...
// Export render functions for popup-core.js
if (typeof window !== "undefined") {
  window.renderLiveSlots = renderLiveSlots;
  window.renderLocations = renderLocations;
  window.renderSlotHistory = renderSlotHistory;
  window.updateStats = updateStats;
  window.renderFavLocations = renderFavLocations;
  window.updateLastCheck = updateLastCheck;
}

export { renderLiveSlots, renderLocations, renderSlotHistory, updateStats, renderFavLocations, updateLastCheck };
