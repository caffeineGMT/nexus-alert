...
export const metadata = {
  ...
  description: '24/7 monitoring for NEXUS, Global Entry, and SENTRI appointment openings. Product Hunt Special: First month free with code PRODUCTHUNT!',
  openGraph: {
    title: 'NEXUS Alert - Never miss a NEXUS appointment',
    description: '24/7 monitoring for NEXUS, Global Entry, and SENTRI appointment openings. Get instant alerts when slots appear.',
    type: 'website',
  },
};
...
export default function ProductHuntLanding() {
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-[#ededed]">
      ...
      <div className="fixed top-0 w-full z-50 bg-gradient-to-r from-[#ff6154] to-[#da552f] text-white">
        <div className="max-w-5xl mx-auto px-6 py-3 flex items-center justify-center text-center">
          <div className="flex items-center gap-2 flex-wrap justify-center">
            <span className="text-lg font-bold">🎉 Product Hunt Special:</span>
            <span className="text-base">First month free with code <code className="px-2 py-1 bg-white/20 rounded font-mono font-bold">PRODUCTHUNT</code></span>
          </div>
        </div>
      </div>

      {/* Nav */}
      <nav className="fixed top-12 w-full z-50 border-b border-[#222] bg-[#0a0a0a]/80 backdrop-blur-md">
        <div className="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <a
            href="https://chrome.google.com/webstore/detail/nexus-alert/EXTENSION_ID?utm_source=producthunt&utm_medium=referral&utm_campaign=ph_launch&utm_content=nav_install"
            target="_blank"
      ...
      <section className="pt-40 pb-20 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="mb-6 flex justify-center">
            <a
              href="https://www.producthunt.com/posts/nexus-alert?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-nexus-alert"
              target="_blank"
              rel="noopener noreferrer"
            >
              <img
                src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=YOUR_POST_ID&theme=dark"
                alt="NEXUS Alert - Never miss a NEXUS appointment slot | Product Hunt"
          ...
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#333] text-sm text-[#888] mb-8">
            ...
            Featured on Product Hunt Today
          </div>
          ...
          <div className="mb-8 p-6 rounded-2xl border-2 border-[#ff6154] bg-gradient-to-br from-[#ff6154]/10 to-[#da552f]/10 max-w-xl mx-auto">
            <div className="text-2xl font-bold mb-2">🚀 Product Hunt Launch Offer</div>
            <div className="text-lg text-[#ccc]">
              Install free, upgrade to Premium for <strong>first month free</strong>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {/* TODO: replace EXTENSION_ID after Chrome Web Store publishing */}
            <a
              href="https://chrome.google.com/webstore/detail/nexus-alert/EXTENSION_ID?utm_source=producthunt&utm_medium=referral&utm_campaign=ph_launch&utm_content=hero_install"
              target="_blank"
              rel="noopener noreferrer"
      ...
      <section className="py-12 px-6 border-t border-[#222] bg-[#111]">
        <div className="max-w-4xl mx-auto text-center">
          <div className="text-sm text-[#888] mb-4">Trusted by travelers waiting for NEXUS appointments</div>
          <div className="flex flex-wrap justify-center gap-8 items-center">
            <div className="text-center">
              <div className="text-3xl font-bold text-white">500+</div>
              <div className="text-sm text-[#888]">Beta Users</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-[#888]">Slots Found</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-5">
            ...
            <FeatureCard
              ...
              description="With Premium tier, get email alerts even when your browser is closed. Never miss a slot."
            />
          </div>
        </div>
      </section>

      {/* Pricing with PH Special Callout */}
      <section className="py-20 px-6 border-t border-[#222] bg-[#050505]">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-8">
            <div className="inline-block px-6 py-2 rounded-full bg-gradient-to-r from-[#ff6154] to-[#da552f] text-white font-semibold mb-4">
              🎉 Product Hunt Launch Offer
            </div>
            <h2 className="text-3xl font-bold mb-4">Get started free, upgrade anytime</h2>
            <p className="text-[#888] max-w-2xl mx-auto">
              First month of Premium free with code <strong>PRODUCTHUNT</strong> — limited time offer!
            </p>
          </div>
          <PricingSection />
        </div>
      ...
      <section className="py-24 px-6 border-t border-[#222]">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="mb-8 p-4 rounded-xl bg-[#111] border border-[#333] inline-block">
            <div className="text-sm text-[#888] mb-1">Product Hunt Special:</div>
            <div className="text-xl font-bold">First month free with code <code className="px-2 py-1 bg-[#222] rounded font-mono">PRODUCTHUNT</code></div>
          </div>
          {/* TODO: replace EXTENSION_ID after Chrome Web Store publishing */}
          <div>
            <a
              href="https://chrome.google.com/webstore/detail/nexus-alert/EXTENSION_ID?utm_source=producthunt&utm_medium=referral&utm_campaign=ph_launch&utm_content=cta_install"
              target="_blank"
              rel="noopener noreferrer"
...
function FAQSection() {
  const faqs = [
    ...
    {
      q: 'Is it free?',
      a: 'Yes — the core extension is completely free. It checks for slots every 30 minutes and sends desktop and sound notifications. The Premium plan ($4.99/mo) upgrades you to 2-minute checks plus email and SMS alerts even when your browser is closed. Product Hunt users get the first month free with code PRODUCTHUNT!',
    },
    {
    ...
    {
      q: 'How do I use the Product Hunt promo code?',
      a: 'Install the free extension, then upgrade to Premium. During checkout, enter code PRODUCTHUNT to get your first month completely free. After that, it\'s just $4.99/month and you can cancel anytime.',
    },
  ];
