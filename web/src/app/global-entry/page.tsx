      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-[#888] max-w-2xl mx-auto mb-10">
            Monitor Global Entry appointments across 100+ US enrollment centers. Get instant notifications
            when interview slots open up — so you can book it before anyone else.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {/* TODO: replace EXTENSION_ID after Chrome Web Store publishing */}
            <a
              href="https://chrome.google.com/webstore/detail/nexus-alert/EXTENSION_ID?utm_source=global-entry-page"
              target="_blank"
              rel="noopener noreferrer"
      ...
      <section className="py-20 px-6 border-t border-[#222]">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-[#888] text-center max-w-2xl mx-auto mb-14">
            Global Entry slots are released when someone cancels.
      ...
      <section id="how-it-works" className="py-20 px-6 border-t border-[#222]">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-14">
            How NEXUS Alert works for Global Entry
          </h2>
          <div className="grid md:grid-cols-3 gap-8">
            <StepCard
              step={1}
              title="Pick your locations"
              description="Select which Global Entry enrollment centers you want to monitor across the US."
            />
            <StepCard
              step={2}
      ...
      <section className="py-24 px-6 border-t border-[#222]">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="text-[#888] text-lg mb-10">
            Install NEXUS Alert and let it watch for Global Entry openings while you live
...
function FAQSection() {
  const faqs = [
    {
      q: 'How does it work?',
      a: 'NEXUS Alert runs as a Chrome Extension that periodically queries the GOES appointment system for available Global Entry slots. When it detects an opening at your selected enrollment centers, it fires a desktop notification and an audible alert so you can act immediately.',
    },
    {
      q: 'Is it free?',
    ...
    },
    {
      ...
      a: 'NEXUS Alert monitors all Trusted Traveler Programs managed through the GOES system: Global Entry (US customs fast-track), NEXUS (US-Canada border), and SENTRI (US-Mexico border). You can monitor multiple programs and locations simultaneously.',
    },
    {
