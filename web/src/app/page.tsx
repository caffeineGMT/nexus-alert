    ...
    <div className="min-h-screen bg-[#0a0a0a] text-[#ededed]">
      ...
      <section className="py-20 px-6 border-t border-[#222] bg-gradient-to-b from-[#0a0a0a] to-[#0f0f14]">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-[#5865F2]/10 to-[#5865F2]/5 border border-[#5865F2]/30 rounded-2xl p-8 text-center">
            <div className="flex items-center justify-center gap-3 mb-4">
              <svg className="w-10 h-10" fill="#5865F2" viewBox="0 0 71 55">
              ...
              <span className="text-2xl font-bold">200+ Active Members</span>
            </div>
