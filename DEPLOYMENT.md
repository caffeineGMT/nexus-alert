...
- **GitHub Pages** = Staging/Preview environment (auto-deployed)
...
### 2. Production (Vercel) - Manual Only ⚠️
...
### DO NOT (for Production):
- ❌ Deploy to Vercel via CLI
- ❌ Run `vercel`, `vercel deploy`, or any Vercel CLI commands
- ❌ Auto-deploy to Vercel or any other hosting platform

### DO (for Staging):
- ✅ Push to GitHub - this auto-deploys to GitHub Pages staging
- ✅ Run `npm run build` to verify zero errors before pushing
- ✅ Check staging preview at GitHub Pages before asking Michael to deploy to production
...
- Every push to `main` triggers a staging deployment automatically
- Michael reviews staging and manually triggers production when ready
